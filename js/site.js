/* ============================================================
   ...
   Injects the nav and footer from a single source of truth so
   a link change is a one-file edit. No framework, no build.
   Each page includes:
...
(function () {
  ...
  var SOCIALS = [
    { href: "mailto:ej@evanjones.ai", label: "Email",
    ...
    { href: "https://linkedin.com/in/evan-jones-b57a7512b", label: "LinkedIn",
    ...
    { href: "https://github.com/EvanJ3/", label: "GitHub",
  ...
  function socialsMarkup() {
    return '<div class="socials" aria-label="Social links">' +
      SOCIALS.map(function (s) {
        var ext = s.href.indexOf("http") === 0
          ? ' target="_blank" rel="noopener noreferrer"' : "";
        return '<a href="' + s.href + '"' + ext + ' aria-label="' + s.label + '">' +
          '<svg viewBox="0 0 16 16" aria-hidden="true"><path d="' + s.path + '"/></svg></a>';
      }).join("") + "</div>";
  }
  ...
  function renderFooter() {
    ...
    host.innerHTML =
      socialsMarkup() +
      "<p>Evan Jones · Atlanta, GA · © " + new Date().getFullYear() + "</p>";
  }

  function init() { renderNav(); renderFooter(); }
